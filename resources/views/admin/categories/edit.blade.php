        ...
        <div class="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6 mt-16">
            <div class="md:grid md:grid-cols-3 md:gap-6">
                ...
                <div class="mt-5 md:mt-0 md:col-span-2">
                    <x-input name="name" title="Name" :value="$category->name"></x-input>

                    <x-input type="number" name="position" title="Position" :value="$category->position" class="mt-6"></x-input>

                    <x-input type="number" name="parent_id" title="Parent ID" :value="$category->parent_id" class="mt-6"></x-input>

                    <x-checkbox name="enabled" title="Enabled" :value="$category->enabled" class="mt-6"></x-checkbox>
                </div>
            </div>
        </div>
