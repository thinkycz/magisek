        ...
        <div class="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6 mt-16">
            <div class="md:grid md:grid-cols-3 md:gap-6">
                ...
                <div class="mt-5 md:mt-0 md:col-span-2">
                    <x-input name="name" title="Name" :value="$status->name"></x-input>

                    <x-input name="description" title="Description" :value="$status->description" class="mt-6"></x-input>

                    <x-input type="color" name="color" title="Color" :value="$status->color" class="mt-6"></x-input>

                    <x-checkbox name="is_final" title="Is Final" :value="$status->is_final" class="mt-6"></x-checkbox>
                </div>
            </div>
        </div>
