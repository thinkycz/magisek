        ...
        <div class="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6 mt-16">
            <div class="md:grid md:grid-cols-3 md:gap-6">
                ...
                <div class="mt-5 md:mt-0 md:col-span-2">
                    ...
                    <x-input type="number" name="price" title="Price" :value="$deliveryMethod->price"
                             class="mt-6"></x-input>

                    <x-input name="mov" title="Minimum Order" :value="$deliveryMethod->mov" class="mt-6"></x-input>

                    <x-checkbox name="needs_shipping_address" title="Needs shipping address"
                                :value="$deliveryMethod->needs_shipping_address" class="mt-6"></x-checkbox>

                    <x-checkbox name="price_will_be_calculated" title="Price will be calculated"
                                :value="$deliveryMethod->price_will_be_calculated" class="mt-6"></x-checkbox>

                    <x-checkbox name="enabled" title="Enabled" :value="$deliveryMethod->enabled"
