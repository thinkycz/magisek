        ...
        <div class="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6 mt-16">
            <div class="md:grid md:grid-cols-3 md:gap-6">
                ...
                <div class="mt-5 md:mt-0 md:col-span-2">
                    <x-input name="name" :title="__('countries.name')" :value="$country->name"></x-input>

                    <x-input name="isocode2" :title="__('countries.iso_code_2')" :value="$country->isocode2" class="mt-6"></x-input>

                    <x-input name="isocode3" :title="__('countries.iso_code_3')" :value="$country->isocode3" class="mt-6"></x-input>

                    <x-checkbox name="enabled" :title="__('countries.enabled')" :value="$country->enabled" class="mt-6"></x-checkbox>
                </div>
            </div>
        </div>
