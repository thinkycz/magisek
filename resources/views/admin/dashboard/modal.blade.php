<div x-data="{ show: false }">
    <x-button @click="show = true" class="bg-red-600 hover:bg-red-500">Very dangerous button</x-button>

    <div x-show="show" class="fixed bottom-0 inset-x-0 px-4 pb-4 sm:inset-0 sm:flex sm:items-center sm:justify-center">
        <div x-show="show"
