<div class="flex-1">
    <div class="flex-1 relative z-10">
        <div>
            ...
            <div class="relative rounded-md shadow-sm">
                ...
                <input wire:model="value" id="search"
        ...
        @if(strlen($value))
            <div class="bg-white w-full rounded mt-4 shadow-lg absolute border">
    ...
    @if(strlen($value))
        <div class="w-full h-full fixed left-0 top-0" style="background-color: rgba(0, 0, 0, 0.5)"></div>
    @endif
</div>
