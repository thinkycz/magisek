    ...
    @if($eligibleToApply)
        <div x-data="{ open: false }" class="w-80">
            <button x-show="!open" @click="open = true"
                    class="text-sm font-semibold text-gray-600 hover:underline flex items-center">
            ...
            <div x-show="open">
                <x-form wire:submit.prevent="apply" class="space-y-2">
                    <x-input name="code" :title="__('global.coupon_code')" wire:model.defer="code"></x-input>
